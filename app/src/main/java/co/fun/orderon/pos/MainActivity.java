...
public class MainActivity extends AppCompatActivity {
    ...
    private void selectDefaultPrinter() {
        ...
        if(bluetoothDevicesList != null && bluetoothDevicesList.length > 0) selectedDevice = bluetoothDevicesList[0];
    }
    ...
    public void printTcp(String data) {
    ...
    public void printIt(DeviceConnection printerConnection) {
        try {
            ...
            printer
                    .printFormattedText(
                            "[C]<img>" + PrinterTextParserImg.bitmapToHexadecimalString(printer, this.getApplicationContext().getResources().getDrawableForDensity(android.R.drawable.star_on, DisplayMetrics.DENSITY_MEDIUM)) + "</img>\n" +
                                    "[L]\n" +
